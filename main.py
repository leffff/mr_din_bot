...
def help(update, context):  # help поможет в будущем пользователю разобраться с возможностями бота
    ...
    # update.message.reply_text("Пока что, я ничего не умею, но скоро всему научусь) попробуйте /купшыеук", reply_markup=markup)
    update.message.reply_text("Пока что, я ничего не умею, но скоро всему научусь) попробуйте /register§")
